              ...
              >
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(handleEmailSubmit)} className="space-y-4">
                          ...
                          <FormControl>
                            <div className="relative group">
                              ...
                              <Input 
                                ...
                                {...field} 
                                className="bg-secondary/50 border-border text-foreground placeholder-muted-foreground pl-11 h-12 rounded-xl focus:border-primary focus:ring-1 focus:ring-primary/20" 
                                autoFocus
                              />
                            </div>
                          </FormControl>
                    ...
                    <Button
                      type="submit"
                      className="w-full bg-primary text-primary-foreground font-medium py-3 h-12 rounded-xl hover:bg-primary/90 transition-all duration-300"
                      disabled={isLoading}
                    >
                      {isLoading ? (
                ...
                <Button
                  ...
                  disabled={isLoading}
                  className="w-full flex items-center justify-center gap-3 py-3 h-12 rounded-xl border border-border text-foreground font-medium hover:bg-secondary/50 transition-all duration-300 bg-transparent"
                >
                    ...
                    <InputOTPGroup>
                      {[0, 1, 2, 3, 4, 5].map((index) => (
                        <InputOTPSlot 
                          key={index} 
                          index={index}
                          className="w-10 h-12 text-xl border-border bg-secondary/50 rounded-lg"
                        />
                      ))}
                    </InputOTPGroup>
                  </InputOTP>
