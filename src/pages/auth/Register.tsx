      ...
      >
        ...
        >
          {isSuccess ? (
            ...
            >
              ...
              <h2 className="text-2xl font-bold mb-2 font-heading">Welcome to InvestorPaisa!</h2>
        ...
        <motion.div className="text-center mt-8" variants={itemVariants}>
          <p className="text-muted-foreground">
            ...
            <Link to="/auth/login" className="text-primary hover:text-primary/80 transition-colors duration-300 font-medium">
              Sign in here
            </Link>
          </p>
        </motion.div>
